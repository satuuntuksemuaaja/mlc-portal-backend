...
import { AdminPendingClientsListController } from '../src/controller/client/get.admin.pending.clients.list.controller';
...
const httpTrigger: AzureFunction = async function (
  ...
  try {
     ...
     * Pending client list
     */
    const clients: ClientResponse = await new AdminPendingClientsListController(
      context
    ).run();
    ...
    console.log('Pending client list index file - catch block', ex);
