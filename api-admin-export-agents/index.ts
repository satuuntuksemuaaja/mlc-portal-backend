...
import { ExportAgentResponse } from '../src/interface/response/export.response.interface';
import { AdminExportAgentsController } from '../src/controller/export/get.admin.export.agents.controller';
...
const httpTrigger: AzureFunction = async function (
  ...
  try {
    ...
    /**
     * Role - Admin
     * Export of the agent table for the organisation
     */
    const result: ExportAgentResponse = await new AdminExportAgentsController(
      context
    ).run();
    ...
    console.log('Export of the agent table index file - catch block', ex);
