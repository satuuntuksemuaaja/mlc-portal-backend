...
import { ClientPhotoResponse } from '../src/interface/response/client.response.interface';
import { GetClientPhotoController } from '../src/controller/client/get.client.photo.controller';
...
const httpTrigger: AzureFunction = async function (
  ...
  try {
     ...
     */
    const result: ClientPhotoResponse = await new GetClientPhotoController(
      context
    ).run();
