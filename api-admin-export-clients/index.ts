...
import { ExportClientRespons } from '../src/interface/response/export.response.interface';
import { AdminExportClientsController } from '../src/controller/export/get.admin.export.clients.controller';
...
const httpTrigger: AzureFunction = async function (
  ...
  try {
    ...
    /**
     * Role - Admin
     * Export of the client table for the organisation
     */
    const result: ExportClientRespons = await new AdminExportClientsController(
      context
    ).run();
    ...
    console.log('Export of the client table index file - catch block', ex);
