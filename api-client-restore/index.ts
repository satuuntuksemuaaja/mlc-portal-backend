...
import { UpdateRestorClientController } from '../src/controller/client/update.restore.client.controller';
...
const httpTrigger: AzureFunction = async function (
  ...
  try {
     ...
     * Restore an client
     */
    const result: ClientResponse = await new UpdateRestorClientController(context).run();
    ...
    if (ex?.statusCode) {
      ...
      console.log('restore client request Failed', ex);
