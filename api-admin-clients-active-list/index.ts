...
import { AdminActiveClientsListController } from '../src/controller/client/get.admin.active.clients.list.controller';
...
const httpTrigger: AzureFunction = async function (
  ...
  try {
     ...
     * Active client list
     */
    const clients: ClientResponse = await new AdminActiveClientsListController(
      context
    ).run();
