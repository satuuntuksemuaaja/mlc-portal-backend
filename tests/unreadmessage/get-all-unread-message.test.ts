...
import httpTrigger from '../../api-unread-message/index';
...
describe('Test to archive client', () => {
  ...
  it('Valid Admin agent should be able to get all unread messages - Http status code: 200', async () => {
    context.req = {
      headers: {
  ...
  it('User level agent should be able to get all unread messages', async () => {
    context.req = {
      headers: {
