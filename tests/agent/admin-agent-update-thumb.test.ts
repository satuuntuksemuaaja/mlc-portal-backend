...
import httpTrigger from '../../api-admin-agent-update-thumb/index';
...
describe('Test', () => {
  let context: Context;
  let agent: Promise<CreateAgentResponse>;
  ...
  it('Valid Admin agent should be able to update agent thumb - Http status code: 200', async () => {
    ...
    expect(context?.res?.body.id).toBe(newAgent.id);
    expect(context?.res?.body.photo).toBe(
      'data:image/png;base64,'
    );
  });
  ...
  it('Valid Admin agent should not be able to update agent thumb from other organisation', async () => {
    const newAgent = await Promise.resolve(agent);
    expect(newAgent).toBeDefined();
    expect(newAgent.roleId).toBe('1002');
    expect(newAgent.name).toBe('Acme Admin agent1');
  ...
  it('Valid Admin agent should fail with status code 400 for invalid request', async () => {
    ...
    context.req = {
      ...
      body: {
        id: '1234', // Invalid id.
        thumbs: 'iVBORw0KGgoAAAANSUhEUgAAAfMA' // thumb to thums
      }
    };
    await httpTrigger(context);
