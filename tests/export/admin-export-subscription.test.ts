...
import httpTrigger from '../../api-admin-export-subscription/index';
import { TestData } from '../data/testdata';

describe('Test to export client', () => {
  let context: Context;
  ...
  it('Valid Admin agent should be able to list subscriptions - Http status code: 200', async () => {
    context.req = {
      headers: {
    ...
    expect(context?.res?.body?.report).toEqual('subscriptions');
