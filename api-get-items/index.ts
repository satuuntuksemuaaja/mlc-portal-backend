...
import { GetItemsController } from '../src/controller/item/get.items.controller';
import { MeecoItem } from '../src/meeco/item/item.model';
...
const httpTrigger: AzureFunction = async function (
  ...
  try {
     ...
     */
    const result: MeecoItem[] = await new GetItemsController(context).run();
    console.log('Success');
    ...
    if (ex?.statusCode) {
      ...
      console.log('Get Items Request Failed', ex);
