...
import { UpdateMessaageAsReadByClientId } from '../src/controller/unreadMessage/put.message.readByClientId.controller';
...
const httpTrigger: AzureFunction = async function (
  ...
  try {
    ...
    const resp = await new UpdateMessaageAsReadByClientId(context).run();
