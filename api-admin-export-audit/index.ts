...
import { ExportAuditResponse } from '../src/interface/response/export.response.interface';
import { AdminExportAuditController } from '../src/controller/export/get.admin.export.audit.controller';
...
const httpTrigger: AzureFunction = async function (
  ...
  try {
     ...
     */
    const result: ExportAuditResponse = await new AdminExportAuditController(
      context
    ).run();
